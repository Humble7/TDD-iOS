...
final class RemoteFeedLoaderTests: XCTestCase {
    ...
    func test_load_deliversErrorOnClientError() {
        ...
        expect(sut, toCompeteWithError: .connectivity, when: {
    ...
    func test_load_deliversErrorOnNon200HTTPResponse() {
        ...
        samples.enumerated().forEach { index, code in
            expect(sut, toCompeteWithError: .invalidData, when: {
    ...
    private func expect(_ sut: RemoteFeedLoader, toCompeteWithError error: RemoteFeedLoader.Error, when action: (() -> Void), file: StaticString = #file, line: UInt = #line) {
